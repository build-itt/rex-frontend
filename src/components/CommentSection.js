...
export default function CommentSectionComponent() {
  ...
  const fetchComments = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`https://rex-backend.vercel.app/store/comments/`, {
  ...
  const handlePostComment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://rex-backend.vercel.app/store/create-comment/',
        formData,
        {
          headers: {
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      ...
      await axios.delete(`https://rex-backend.vercel.app/store/delete-comment/${commentId}/`, {
        headers: {
          'Authorization': `Token ${token}`,
        },
      });
