        ...
        <tbody>
          {banks.map((bank, index) => (
            <tr key={bank.id} className={`typing-row-${index + 1} border-t`}>
              ...
              <td className="px-4 py-2"><span className="table-typing">{bank.Title}</span></td>
              <td className="px-4 py-2"><span className="table-typing">{bank.Info}</span></td>
              <td className="px-4 py-2"><span className="table-typing">{bank.Status ? "Active" : "Inactive"}</span></td>
